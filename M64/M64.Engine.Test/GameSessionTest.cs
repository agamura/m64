#region Header
//+ <source name="GameSessionTest.cs" language="C#" begin="13-Feb-2012">
...
namespace M64.Engine.Test
{
    ...
    class GameSessionTest
    {
        ...
        {
            GameSession gameSession = new GameSession(null);
        }
