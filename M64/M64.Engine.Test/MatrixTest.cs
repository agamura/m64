#region Header
//+ <source name="MatrixTest.cs" language="C#" begin="14-Nov-2011">
...
namespace M64.Engine.Test
{
    ...
    class MatrixTest
    {
        ...
        {
            Matrix matrix = new Matrix(Matrix.MinDimensionLength - 1, Matrix.MinDimensionLength - 1);
        }
        ...
        {
            Matrix matrix = new Matrix(Matrix.MaxDimensionLength + 1, Matrix.MaxDimensionLength + 1);
        }
        ...
        {
            Matrix matrix = new Matrix(Width, Height);
            Position position = matrix.GetPosition((Width * Height) + 1);
        }
